...
public class CookiesAdapter extends BaseAdapter {
	...
	public CookiesAdapter(Activity activity1, List<String> course_list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.name.setText(course.get(position));
		 switch(position)
	        {
	        case 0:
	        	holder.image.setImageResource(R.drawable.non_veg_meal);
	        	break;
