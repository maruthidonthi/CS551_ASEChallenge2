...
public class ListAdapter extends BaseAdapter {
	...
	public ListAdapter(Activity activity1, List<String> course_list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.name.setText(course.get(position));
		 switch(position)
	        {
	        case 0:
	        	holder.image.setImageResource(R.drawable.bathroom);
	        	break;
	        case 1:
	        	holder.image.setImageResource(R.drawable.tools);
	        	break;
