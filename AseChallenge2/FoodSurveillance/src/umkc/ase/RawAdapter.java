...
public class RawAdapter extends BaseAdapter {
	...
	public RawAdapter(Activity activity1, List<String> course_list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.name.setText(course.get(position));
		 switch(position)
	        {
	        case 0:
	        	holder.image.setImageResource(R.drawable.raw);
	        	break;
